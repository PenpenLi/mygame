...
UI_embassyInfo = class("UI_embassyInfo", UI)


--init
function UI_embassyInfo:init(building_)
	...
	--tittle
	tittleCont:getChildByName("Label_head"):setString(string.format( hp.lang.getStrByID(7201),hp.lang.getStrByID(6501) ))
	
	--head
	item1Cont:getChildByName("Label_level"):setString(hp.lang.getStrByID(1039))
	item1Cont:getChildByName("Label_col"):setString(hp.lang.getStrByID(7202))
	...
	--item
	for i,info in ipairs(game.data.embassy) do
		...
		itemCont:getChildByName("Label_col"):setString(info.alliedTroopDEFMax)
	...
	panelInfo:getChildByName("Panel_cont"):getChildByName("Label_info"):
		setString(hp.lang.getStrByID(7203))
