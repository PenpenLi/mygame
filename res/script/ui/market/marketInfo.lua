...
UI_marketInfo = class("UI_marketInfo", UI)


--init
function UI_marketInfo:init(building_)
	...
	--tittle
	tittleCont:getChildByName("Label_head"):setString(string.format( hp.lang.getStrByID(7301),hp.lang.getStrByID(6401) ))
	
	--head
	item1Cont:getChildByName("Label_level"):setString(hp.lang.getStrByID(1039))
	item1Cont:getChildByName("Label_col"):setString(hp.lang.getStrByID(7302))
	item1Cont:getChildByName("Label_col_0"):setString(hp.lang.getStrByID(7303))
	...
	--item
	for i,info in ipairs(game.data.market) do
		...
		itemCont:getChildByName("Label_col"):setString(info.donateMax)
		itemCont:getChildByName("Label_col_0"):setString(info.taxRate .. "%")
	...
	panelInfo:getChildByName("Panel_cont"):getChildByName("Label_info"):
		setString(hp.lang.getStrByID(7304))
