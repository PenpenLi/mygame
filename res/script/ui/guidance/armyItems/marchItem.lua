--
-- ui/guidance/armyItems/marchItem.lua
-- 行军
--===================================
			...
			if status == 200 then
				...
				if res.result ~= nil and res.result == 0 then
					if res.x == 0 and res.y == 0 then
						local msgbox = UI_msgBox.new(hp.lang.getStrByID(6034), hp.lang.getStrByID(11508), hp.lang.getStrByID(1209))
						parent:addModalUI(msgbox)
						return
					end
...
function MarchItem.getCheckIndex()
	return index
end
