--
-- ui/bigMap/source/unionSource.lua
-- 点击资源弹出UI 
--===================================
require "ui/UI"
...
function UI_unionSource:initUI()
	...
	self.view:getChildByName("Label_13776"):setString(hp.lang.getStrByID(1312))
...
function UI_unionSource:initShow()
	...
	if armyInfo_.unionID ~= 0 then
		...
		cclog_("UI_unionSource:initShow error:unionID = 0!")
	end
end

function UI_unionSource:getType()
	return globalData.ARMY_BELONG.ALLIANCE
end

function UI_unionSource:updateInfo()
	self:initShow()
end

function UI_unionSource:onRemove()
